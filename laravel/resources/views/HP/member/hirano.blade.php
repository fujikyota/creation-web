...
<div class="member__qa">
    <div class="interview__body1">
        <div class="photo1">
            <img src="/img/hiranomiddle.jpg" alt="" class="qa__photo1">
        </div>
    ...
    <div class="photo2">
            <img src="/img/hiranobottom.jpg" alt="" class="qa__photo2">
        </div>
    ...
    <div class="interview__body4">
        <div class="photo2">
        <img src="/img/hiranohead.jpg" alt="" class="qa__photo3">
        </div>
